...
public class ConsumivelConsultaView extends javax.swing.JFrame {

    private final Consumer<Consumivel> onConfirm;
    private final ConsumivelService service = new ConsumivelService();
    private List<Consumivel> list;
    ...
    private void confirmar() {
        Consumivel consumivel = list.get(jTableConsulta.getSelectedRow());
        onConfirm.accept(consumivel);
        this.dispose();
    }
