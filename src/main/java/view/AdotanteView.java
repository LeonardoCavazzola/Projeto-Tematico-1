...
public class AdotanteView extends javax.swing.JFrame implements AdotanteConsultaOwner {
    ...
    private final AdotanteService service = new AdotanteService();
    ...
    private void setEntity(Adotante adotante) {
        ...
        this.jTextFieldNome.setText(adotante.getNome());
        this.jFormattedTextFieldNascimento.setText(StringLocalDateConverter.localDateToString(adotante.getNascimento()));
    ...
    private void update() {
        this.adotante.setNome(jTextFieldNome.getText());
        this.adotante.setNascimento(StringLocalDateConverter.stringToLocalDate(jFormattedTextFieldNascimento.getText()));
        this.service.update(adotante);
    }
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        this.showAdotanteConsulta(this::setEntity);
