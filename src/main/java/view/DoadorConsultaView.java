...
public class DoadorConsultaView extends javax.swing.JFrame {

    private final Consumer<Doador> onConfirm;
    private final DoadorService service = new DoadorService();
    private List<Doador> list;
    ...
    private void confirmar() {
        Doador doador = list.get(jTableConsulta.getSelectedRow());
        onConfirm.accept(doador);
        this.dispose();
    }
