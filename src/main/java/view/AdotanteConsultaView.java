...
public class AdotanteConsultaView extends javax.swing.JFrame {

    private final Consumer<Adotante> onConfirm;
    private final AdotanteService service = new AdotanteService();
    private List<Adotante> list;
    ...
    private void confirmar() {
        Adotante adotante = list.get(jTableConsulta.getSelectedRow());
        onConfirm.accept(adotante);
        this.dispose();
    }
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                                ...
                                                .addComponent(jButtonProcurar, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap())
        );
