...
public class UsuarioConsultaView extends javax.swing.JFrame {

    private final Consumer<Usuario> onConfirm;
    private final UsuarioService service = new UsuarioService();
    private List<Usuario> list;

    public UsuarioConsultaView(Consumer<Usuario> onConfirm) {
        initComponents();
    ...
    private void confirmar() {
        Usuario usuario = list.get(jTableConsulta.getSelectedRow());
        onConfirm.accept(usuario);
        this.dispose();
    }
